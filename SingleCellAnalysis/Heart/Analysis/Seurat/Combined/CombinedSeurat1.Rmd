...
# Note that the expression data here Group_data have already been normalized
# So for clustering with seurat, I would start from finding variable genes and
# scaling. So skip the normalization step. 
# Save as a csv file with the purpose of re-running the analysis with
# clusters 0,1,2 and 3 raw data

...
dim(ExpressionData)
# Confirms we have genes as row names and cells as column names with 27998 genes and 1417 cells
...
# Old has 770 cells while Young has 647 cells (In total 1417)
...
# This has genes as rows (27966) and cells as columns (1417)

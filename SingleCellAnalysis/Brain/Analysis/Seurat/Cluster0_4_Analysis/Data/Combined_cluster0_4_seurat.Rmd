...
Combined_Group = read.csv("/Users/emechebe/Desktop/Combined/Combined_0_3_clusters.csv",row.names=1)
# Sanity check
Combined_Group[1:3,1:3]

# read in the annotation file
Annotation = read.csv("/Users/emechebe/Desktop/Combined/GroupAnnotation.csv", row.names= 1)
# Sanity check
head(Annotation)
...
VlnPlot(object = New, features.plot = c("Gm10076", "Itm2a",'Car4','Cst3','Rpl9-ps6','Apoe'))
VlnPlot(object = New, features.plot = c("Igf1r", "Adgrf5",'Pdgfb','Agrn','Itga6','Eogt'))
VlnPlot(object = New, features.plot = c("Junb", "Fos",'Btg2','Atf3','Egr1','Ier2'))
VlnPlot(object = New, features.plot = c("Gkn3", "Mgp",'Stmn2','Vegfc','Alpl','Clu'))
...
# Top markers plots
# Cluster 1
FeaturePlot(object = New, features.plot = c("Gm10076", "Itm2a",'Car4','Cst3','Rpl9-ps6','Apoe'), cols.use = c("grey", "blue"),reduction.use = "tsne")

# Cluster 2
FeaturePlot(object = New, features.plot = c("Igf1r", "Adgrf5",'Pdgfb','Agrn','Itga6','Eogt'), cols.use = c("grey", "blue"),reduction.use = "tsne")
# Cluster 3
FeaturePlot(object = New, features.plot = c("Junb", "Fos",'Btg2','Atf3','Egr1','Ier2'), cols.use = c("grey", "blue"),reduction.use = "tsne")
# Cluster 4
FeaturePlot(object = New, features.plot = c("Gkn3", "Mgp",'Stmn2','Vegfc','Alpl','Clu'), cols.use = c("grey", "blue"),reduction.use = "tsne")

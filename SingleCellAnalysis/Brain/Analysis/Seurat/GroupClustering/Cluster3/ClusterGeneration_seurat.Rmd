...
Combined_Group = read.csv("/Users/emechebe/Desktop/Cluster0_4_Analysis/Data/Combined_3_clusters.csv",row.names=1)
# Sanity check
Combined_Group[1:3,1:3]

# read in the annotation file
Annotation = read.csv("/Users/emechebe/Desktop/Cluster0_4_Analysis/Data/GroupAnnotation_3.csv", row.names= 1)
# Sanity check
head(Annotation)
...
New.markers <- FindAllMarkers(object = New, only.pos = TRUE, min.pct = 0.25, 
    thresh.use = 0.25)
New.markers %>% group_by(cluster) %>% top_n(6, avg_logFC)

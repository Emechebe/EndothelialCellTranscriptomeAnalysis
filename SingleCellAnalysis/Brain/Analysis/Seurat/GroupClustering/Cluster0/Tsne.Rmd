...
Combined_Group = read.csv("/Users/emechebe/Desktop/Cluster0_4_Analysis/Data/Combined_0_clusters.csv",row.names=1)
# Sanity check
Combined_Group[1:3,1:3]

# read in the annotation file
Annotation = read.csv("/Users/emechebe/Desktop/Cluster0_4_Analysis/Data/GroupAnnotation_0.csv", row.names= 1)
# Sanity check
head(Annotation)
...
VlnPlot(object = New, features.plot = c("Malat1", "Igf1r",'Clec2d','Srsf2','Rapgef4','Slc7a1'))
VlnPlot(object = New, features.plot = c("Ctnnb1", "Rps6",'Rgs5','Rps12','Kctd10','Erg'))
...
# Top markers plots
# Cluster 0
FeaturePlot(object = New, features.plot = c("Malat1", "Igf1r",'Clec2d','Srsf2','Rapgef4','Slc7a1'), cols.use = c("grey", "blue"),reduction.use = "tsne")
# Cluster 1
FeaturePlot(object = New, features.plot = c("Ctnnb1", "Rps6",'Rgs5','Rps12','Kctd10','Erg'), cols.use = c("grey", "blue"),reduction.use = "tsne")

...
dense.size <- object.size(x = as.matrix(x = old.data))
dense.size
sparse.size <- object.size(x = old.data)
sparse.size
...
VlnPlot(object = old, features.plot = c("Junb", "Jun",'Jund','Fos','Cdkn1a','Ier2'))
VlnPlot(object = old, features.plot = c("Nfib",'Igf1r','Mcf2l','Kdr','Cxcl12','Hmcn1'))
VlnPlot(object = old, features.plot = c('Stmn2','Gkn3','Tm4sf1','Lypd1','Mgp','Clu'))
VlnPlot(object = old, features.plot = c('Fth1','Lcn2','Lrg1','Vcam1','Icam1','Ptgs2'))
VlnPlot(object = old, features.plot = c('Myl9','Atp1a2','Vtn','Cald1','Gm13889','Rgs4'))
VlnPlot(object = old, features.plot = c('Myl9','Atp1a2','Vtn','Cald1','Acta2','Rgs4'))

FeaturePlot(object = old, features.plot = c("Junb", "Jun",'Jund','Fos','Cdkn1a','Ier2'), cols.use = c("grey", "blue"),reduction.use = "tsne")
FeaturePlot(object = old, features.plot = c("Nfib",'Igf1r','Mcf2l','Kdr','Cxcl12','Hmcn1'), cols.use = c("grey", "blue"),reduction.use = "tsne")
FeaturePlot(object = old, features.plot = c('Stmn2','Gkn3','Tm4sf1','Lypd1','Mgp','Clu'), cols.use = c("grey", "blue"),reduction.use = "tsne")
FeaturePlot(object = old, features.plot = c('Fth1','Lcn2','Lrg1','Vcam1','Icam1','Ptgs2'), cols.use = c("grey", "blue"),reduction.use = "tsne")
...
top10 <- old.markers %>% group_by(cluster) %>% top_n(10, avg_logFC)
# setting slim.col.label to TRUE will print just the cluster IDS instead of
# every cell name
DoHeatmap(object = old, genes.use = top10$gene, slim.col.label = TRUE, remove.key = TRUE)
